...
@Component({
  selector: 'app-carousel-section2',
  templateUrl: './carousel-section2.component.html',
  styleUrls: ['./carousel-section2.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CarouselSection2Component {
